    ...
    return (
        <section style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
            <article style={{ backgroundColor: 'white', padding: '20px 100px 10px 10px', height:'400px' }}>
                <div style={{ display: 'flex' }}>
                    ...
                    <div style={{ padding: '10px 0' }}>
                        ...
                        <span style={{ color: '#135846', marginRight: '10px' }}><LocalPhoneIcon /></span>
                        <button style={{ backgroundColor: '#135846', border: 'none', padding: '10px 10px 5px', color: 'white', borderRadius: '5px' }}><MessageIcon /> <span style={{ position: 'relative', top: '-8px' }}>Send Message</span></button>
                    </div>
                </div>
                <div style={{display: 'flex', paddingLeft:'15px', marginBottom:'10px'}}>
                    <div style={{marginRight:'84px'}}>
                        <p style={{fontSize:'10px',color:'gray', fontWeight:'700'}}>Check In</p>
                        <p style={{fontSize:'12px', fontWeight:'700'}}>{book[0].checkIn}</p>
                    </div>
                    <div>
                        <p style={{fontSize:'10px',color:'gray', fontWeight:'700'}}>Check Out</p>
                        <p style={{fontSize:'12px', fontWeight:'700'}}>{book[0].checkOut}</p>
                    </div>
                </div>
                <div style={{ width: '130%', height: '1px', backgroundColor: 'gray', marginBottom:'10px' }}></div>
                <div style={{ display: 'flex',paddingLeft:'15px', marginBottom:'10px' }}>
                    ...
                    <div>
                        ...
                        <p style={{fontSize:'15px', fontWeight:'700'}}>$145 <span style={{fontSize:'10px', fontWeight:'700', color:'gray'}}>/night</span></p>
                    </div>
                </div >
            ...
            <article style={{width: '390px', position:'relative', top:'2px'}}>
                ...
                <p style={{position:'absolute', top:'20px', right:'10px', backgroundColor:'green', color:'white', transform: 'Rotate(40deg)', padding:'5px'}}>{book[0].status} Booked</p>
            </article>
        </section>
    )
}